        ...
        <div>
            <div class="flex justify-evenly space-x-8 text-white text-2xl">
                ...
                <div class="bg-indigo-500 opacity-70 w-2/6 h-40 rounded-xl flex justify-between p-4">
                    <section>
                        Universités
                        <h3 class="mt-5">{{ $nbUn }}</h3>
                    </section>

                    <svg data-name="Layer 1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#fbff00" class="fill-000000"></path>
                    </svg>
                </div>
                ...
                <div class="bg-sky-500 opacity-70 w-2/6 h-40 rounded-xl flex justify-between p-4">
                    ...
                    <?xml version="1.0" ?><svg id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1"
                        ...
                        <g>
                            <g>
                                <path
                                    d="M11,21H3c-0.5527344,0-1-0.4472656-1-1v-8c0-0.5527344,0.4472656-1,1-1h8c0.5527344,0,1,0.4472656,1,1v8    C12,20.5527344,11.5527344,21,11,21z M4,19h6v-6H4V19z" />
                            </g>
                            <g>
                                <path
                                    d="M29,28h-8c-0.5527344,0-1-0.4472656-1-1v-8c0-0.5527344,0.4472656-1,1-1h8c0.5527344,0,1,0.4472656,1,1v8    C30,27.5527344,29.5527344,28,29,28z M22,26h6v-6h-6V26z" />
                            </g>
                            <g>
                                <path
                                    d="M29,12h-8c-0.5527344,0-1-0.4472656-1-1V3c0-0.5527344,0.4472656-1,1-1h8c0.5527344,0,1,0.4472656,1,1v8    C30,11.5527344,29.5527344,12,29,12z M22,10h6V4h-6V10z" />
                            </g>
                            <g>
                                <path
                                    d="M16,32c-0.5527344,0-1-0.4472656-1-1V1c0-0.5527344,0.4472656-1,1-1s1,0.4472656,1,1v30    C17,31.5527344,16.5527344,32,16,32z" />
                            </g>
                            <g>
                                <path
                                    d="M16,17h-5c-0.5527344,0-1-0.4472656-1-1s0.4472656-1,1-1h5c0.5527344,0,1,0.4472656,1,1S16.5527344,17,16,17z" />
                            </g>
                            <g>
                                <path
                                    d="M21,8h-5c-0.5527344,0-1-0.4472656-1-1s0.4472656-1,1-1h5c0.5527344,0,1,0.4472656,1,1S21.5527344,8,21,8z" />
                            </g>
                            <g>
                                <path
                                    d="M21,24h-5c-0.5527344,0-1-0.4472656-1-1s0.4472656-1,1-1h5c0.5527344,0,1,0.4472656,1,1S21.5527344,24,21,24z" />
                            </g>
                        </g>
                    </svg>
                </div>
                ...
                <div class="bg-gray-900 opacity-70 w-2/6 h-40 rounded-xl flex justify-between p-4">
                    ...
                    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="none" stroke="#ff0000" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"
